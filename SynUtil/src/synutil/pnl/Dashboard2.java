...
import synutil.csv_insert.Dlg_csv;
import synutil.login.Dlg_login;
...
public class Dashboard2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pm_t_add = new javax.swing.JMenuItem();
        pm_t_delete = new javax.swing.JMenuItem();
        pm_col = new javax.swing.JPopupMenu();
        pm_c_edit = new javax.swing.JMenuItem();
        pm_c_delete = new javax.swing.JMenuItem();
        ...
        pm_t_add.setText("ADD COLUMN");
        pm_t_add.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pm_t_addActionPerformed(evt);
            }
        });
        pm_table.add(pm_t_add);
        ...
        pm_c_edit.setText("EDIT");
        pm_c_edit.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pm_c_editActionPerformed(evt);
            }
        });
        pm_col.add(pm_c_edit);

        pm_c_delete.setText("DELETE");
        pm_c_delete.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                pm_c_deleteActionPerformed(evt);
            }
        });
        pm_col.add(pm_c_delete);
        ...
        tbl_columns.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tbl_columnsMousePressed(evt);
            }
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                tbl_columnsMouseReleased(evt);
            }
        });
    ...
    private void pm_t_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pm_t_addActionPerformed
        alter_table_add();
    }//GEN-LAST:event_pm_t_addActionPerformed

    private void tbl_columnsMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_columnsMousePressed
        pm_col(evt);
    }//GEN-LAST:event_tbl_columnsMousePressed

    private void tbl_columnsMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_columnsMouseReleased
        pm_col(evt);
    }//GEN-LAST:event_tbl_columnsMouseReleased

    private void pm_c_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pm_c_editActionPerformed
        alter_table_edit();
    }//GEN-LAST:event_pm_c_editActionPerformed

    private void pm_c_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pm_c_deleteActionPerformed
        alter_table_delete();
    }//GEN-LAST:event_pm_c_deleteActionPerformed
...
//                new Dashboard2().setVisible(true);
    ...
    private javax.swing.JMenuItem pm_c_delete;
    private javax.swing.JMenuItem pm_c_edit;
    private javax.swing.JPopupMenu pm_col;
    private javax.swing.JMenuItem pm_t_add;
...
//        init_key();
    ...
    public void log() {
        ...
        Window p1 = (Window) this;
        Dlg_login ndd = Dlg_login.create(p1, true);
        ndd.setTitle("");
        ndd.do_pass("qwe","1");
        ndd.setCallback(new Dlg_login.Callback() {
        ...
        ndd.setSize(xSize, 100);
        Center.setCenter(ndd);
        ndd.setVisible(true);
//        ndd.setVisible(true);
    }
...
//            }
    ...
    private void do_check() {
        ...
        S1_set.to_col order = (S1_set.to_col) tbl_colll_ALM.get(tbl_columns.convertRowIndexToModel(row));
    ...
    private void do_uncheck() {
        ...
        for (int i = 0; i < row; i++) {
            ...
            S1_set.to_col order = (S1_set.to_col) tbl_colll_ALM.get(tbl_columns.convertRowIndexToModel(i));
            order.setCheck(check);
...
//            }
    ...
    private void del_database() {
        ...
        nd.setCallback(new Dlg_confirm.Callback() {
            ...
            public void cont(CloseDialog closeDialog, OutputData data) {
                closeDialog.ok();
                S1_set.delete_database(tf_username.getText(), tf_password.getText(), cb_database.getSelectedItem().
                        toString());
                set_database();
            }
        });
    ...
    private void alter_table_add() {
        ...
        final String database = cb_database.getSelectedItem().
                toString();
        Window p = (Window) this;
        Dlg_column nd = Dlg_column.create(p, true);
        nd.setTitle("");
//        nd.do_pass("");
        nd.setCallback(new Dlg_column.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_column.OutputData data) {
                closeDialog.ok();
                S1_set.add_table_col(tf_username.getText(), tf_password.getText(), database, table_name, data.column, data.type);
                data_cols();
            }
        });
        nd.setLocationRelativeTo(this);
    ...
    private void alter_table_edit() {
        ...
        final String col_name = tbl_columns.getModel().
                getValueAt(row, 0).
                toString();
        final String type = tbl_columns.getModel().
                getValueAt(row, 1).
                toString();
        final String database = cb_database.getSelectedItem().
                toString();
        ...
        Dlg_column nd = Dlg_column.create(p, true);
        nd.setTitle("");
        nd.do_pass(col_name, type);
        nd.setCallback(new Dlg_column.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_column.OutputData data) {
                closeDialog.ok();
                S1_set.edit_table_col(tf_username.getText(), tf_password.getText(), database, table_name, data.column, data.type, col_name);
                data_cols();
            }
        });
        nd.setLocationRelativeTo(this);
    ...
    private void alter_table_delete() {
        int row = tbl_columns.getSelectedRow();
        if (row < 0) {
            return;
        }
        ...
        Dlg_confirm nd = Dlg_confirm.create(p, true);
        nd.setTitle("");
        nd.do_pass("Sure na ni boy George?");
        nd.setCallback(new Dlg_confirm.Callback() {
            ...
            public void cont(CloseDialog closeDialog, OutputData data) {
                closeDialog.ok();
                S1_set.delete_table_col(tf_username.getText(), tf_password.getText(), database, table_name, col_name);
                data_cols();
            }
        });
        nd.setLocationRelativeTo(this);
    ...
    private void pm_col(MouseEvent evt) {
        if (evt.isPopupTrigger()) {
            pm_col.show(evt.getComponent(), evt.getX(), evt.getY());
        }
    }
...
//        ndd.setVisible(true);
    ...
    private void aw() {
        Window p = (Window) this;
        Dlg_csv nd = Dlg_csv.create(p, true);
        nd.setTitle("");
//        nd.do_pass("");
        nd.setCallback(new Dlg_csv.Callback() {

            @Override
            public void ok(CloseDialog closeDialog, Dlg_csv.OutputData data) {
                closeDialog.ok();
            }
        });
//        nd.setLocationRelativeTo(this);
